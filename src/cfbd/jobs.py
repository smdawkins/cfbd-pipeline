...
from .silver import infer_schema_from_sample, parse_raw_to_cols, flatten_structs_until_done, flatten_and_explode_all
from .endpoints import ENDPOINTS
from pyspark.sql import functions as F

BASE_URL = "https://api.collegefootballdata.com"

def run_ingest_to_bronze(spark, api_key: str, bronze_schema: str, endpoint: str, season: int, week: int, division: str = "fbs"):
    conf = ENDPOINTS[endpoint]
    url_path = conf["url"]({"season": season, "week": week, "division": division})
...
def run_build_silver_flat(spark, silver_schema: str, bronze_schema: str, endpoint: str, season: int, week: int, mode: str = "flatten_only"):
    conf = ENDPOINTS[endpoint]
